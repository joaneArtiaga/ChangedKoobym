...
/**
 * Created by Joane14 on 10/09/2017.
 */
...
public class SPUtility {
    ...
    private static final String KEY_SP_NAME = "KOOBYM_SP";

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    private static SPUtility spUtility;

    private SPUtility(Context appContext) {
        preferences = appContext.getSharedPreferences(KEY_SP_NAME, Context.MODE_APPEND);
    }

    public static SPUtility getSPUtil(Context context) {
        if (spUtility == null) {
            spUtility = new SPUtility(context);
        }
    ...
    public double getDouble(String key, double defaultValue) {
        String number = getString(key, Double.toString(defaultValue));
     ...
     *
     * @param key          SharedPreferences key
     * @param defaultValue SharedPreferences defaultValue
    ...
    public Object getObject(String key, Class<?> classOfT) {
        ...
        Gson gson = new GsonBuilder().setDateFormat("MMMM dd, yyyy").create();
