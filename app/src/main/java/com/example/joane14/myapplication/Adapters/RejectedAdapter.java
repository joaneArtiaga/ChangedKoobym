...
public class RejectedAdapter extends RecyclerView.Adapter<RejectedAdapter.BookHolder> {

    public List<RentalHeader> bookList;
    public Activity context;

    @Override
    public RejectedAdapter.BookHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_rejected_item, parent, false);

        this.context = (Activity) parent.getContext();
        Log.d("LandingPAgeAdapter","inside");
        RejectedAdapter.BookHolder dataObjectHolder = new RejectedAdapter.BookHolder(this.context, view);
    ...
    public RejectedAdapter(List<RentalHeader> myDataset) {
        bookList = myDataset;
    }

    @Override
    public void onBindViewHolder(RejectedAdapter.BookHolder holder, int position) {
...
//                    Intent intent = new Intent(LandingPageAdapter.this.context, ViewBookActivity.class);
                    rentalHeaderObj = RejectedAdapter.this.bookList.get(position);
