...
public class ApproveSwapAdapter extends RecyclerView.Adapter<ApproveSwapAdapter.BookHolder> {
    ...
    @Override
    public ApproveSwapAdapter.BookHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ApproveSwapAdapter.BookHolder dataObjectHolder = new ApproveSwapAdapter.BookHolder(this.context, view);

        Log.d("RequestAdapter", String.valueOf(bookList.size()));
        return dataObjectHolder;
    }

    public ApproveSwapAdapter(List<SwapHeader> myDataset) {
        bookList = myDataset;
    }

    @Override
    public void onBindViewHolder(ApproveSwapAdapter.BookHolder holder, final int position) {
...
//                    Intent intent = new Intent(LandingPageAdapter.this.context, ViewBookActivity.class);
                    swapHeaderObj = ApproveSwapAdapter.this.bookList.get(position);
